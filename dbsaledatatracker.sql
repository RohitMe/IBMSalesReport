...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2017 at 07:49 AM
...
--
-- Table structure for table `tproductinfromations`
--

CREATE TABLE `tproductinfromations` (
  `ID` int(11) NOT NULL,
...
--
-- Dumping data for table `tproductinfromations`
--

INSERT INTO `tproductinfromations` (`ID`, `Name`, `Code`) VALUES
(1, 'Product1', '1'),
(2, 'product2', '2'),
(3, 'product3', '3');
...
--
-- Indexes for table `tproductinfromations`
--
ALTER TABLE `tproductinfromations`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `tproductinfromations`
--
ALTER TABLE `tproductinfromations`
